...
from symbolic_args import parse_args
from symbolic_utils import (TARGET_COL_DEFAULT, evaluate_split, load_xy,
                            save_pysr_results, save_test_predictions,
                            setup_logger)
...
def train_symbolic_regression(
    ...
    # Load full dataset from train_csv
    ...
    if val_csv is None and test_csv is None:
        ...
        if val_csv is not None:
            ...
            # If external test is provided, require val_csv as well
            raise ValueError(
...
if __name__ == "__main__":
    ...
    # Initialize logging inside output_dir
